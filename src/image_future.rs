...
/// A future for loading a [HtmlImageElement](https://docs.rs/web-sys/0.3.58/web_sys/struct.HtmlImageElement.html)
/// that will resolve when the image has fully loaded.
///
/// Example:
/// ```rust
/// let image = ImageFuture::new("img/drop-alpha.png").await;
/// ```
///
